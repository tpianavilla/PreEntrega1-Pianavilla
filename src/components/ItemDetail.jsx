        ...
        <Card className="card-main" align={'center'}>
          <CardBody>
            ...
            <Stack mt="8" spacing="5">
              ...
              <Text color="blackAlpha.800" fontSize="lg" as='ins'>
                Descripcion: {product.description}
              </Text>
              <Text color="blackAlpha.800" fontSize="lg" as='sub'>
                Categoria: {product.category}
              </Text>
              <Text color="green.400" fontSize="xl" as='i'>
                Stock: {product.stock}
              </Text>
              <Text color="blackAlpha.900" fontSize="2xl" as='b'>
                Precio: UYU {product.price}
              </Text>
            </Stack>
          </CardBody>
          <Divider />
